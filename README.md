...
| `/loop [name\|stop] [score] [tries]` | Pick a `loop.yaml` record from a list, edit the inputs and limits it starts from, then run the scored loop; `stop` ends the run |
