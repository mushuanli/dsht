...
C4Component
  ...
  Component(controller, "controller/", "11 文件 1952 行", "Controller 门面、命令策略、通用评分循环、设计审查与 /loop 协议、ConnectionController、内存日志与快捷提示词")
...
| `controller/loop.ts` | 171 | `LoopLimits`、`LoopProtocol`、`LoopResult`、`LoopStepResult`、`resolveLoop`、`parseLoopResult`、`latestAssistantText`、`ScoredLoop` |
| `controller/design-review.ts` | 91 | `DESIGN_REVIEW_ROUNDS`、`designReviewProtocol` |
| `controller/loop-contract.ts` | 52 | `LOOP_MARKER`、`LOOP_STATUSES`、`resultContract`、`followUpContract` |
...
C4Component
  ...
  Component(controller, "controller/", "controller, commands, loop, loop-contract, loop-prompt, design-review, connection, memory-log, perf-measures, prompts, index", "11 文件 1952 行")
